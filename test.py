...
# Here, you can define the window window and its properties
window = tk.Tk()
window.title("Business Planner")
window.geometry("600x600")  # Set the dimensions of the window window
...
class RegistrationWindow(tk.Tk):
    ...
    def validate_fullname(self):
        ...
        if not fullname.isalpha():
            return "Invalid fullname. Please enter only alphabetical characters."
